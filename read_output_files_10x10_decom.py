...
directory = "/home/biorobotics/macc_decom_test_7x7"
...
num_agents = []
for filename in glob.glob('/media/storage/shambhavi/macc_experiments/macc_decom_10x10/macc_decom_test_10x10/random*.txt'):
    agents = np.zeros(15)
    print(filename)
